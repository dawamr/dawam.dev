...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    form.append('access_key', 'a9a52802-61da-4e42-ad79-91e5f596b030'); // Replace with your Web3Forms access key
              ...
              <div className='space-y-6'>
                <div className='flex items-center space-x-4'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-400'>admin@dawam.dev</p>
                    <p className='text-gray-400'>id.dawamraja@gmail.com</p>
                  </div>
                </div>
