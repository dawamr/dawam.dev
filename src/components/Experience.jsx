  ...
  const experiences = [
    {
      ...
      company: 'Santren Koding (KodingWorks)',
      period: '2017-2019',
      description:
        'Developed and customized websites for clients, tailoring solutions to meet their specific needs. Authored the book Laravel 5 Bootcamp.',
    },
    {
      icon: Database,
      ...
      period: '2019 - 2020',
      description:
        'Developed and maintained scalable backend systems for various projects, focusing on performance and maintainability.',
    },
    {
      icon: Activity,
      title: 'Full-Stack Developer',
      company: 'Terretech Nusantara (Solarion Group)',
      period: '2020 - 2023',
      description:
        'Designed and implemented comprehensive healthcare management systems integrating electronic medical records, appointment scheduling, and billing modules. Optimized database performance and created responsive interfaces for medical staff and patients.',
    },
    {
      icon: Briefcase,
