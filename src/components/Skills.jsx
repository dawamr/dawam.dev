...
import { FaGolang, FaCloudflare } from 'react-icons/fa6';
  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        {
          name: 'Astro',
          icon: <SiAstro className='w-4 h-4 text-[#FF5D01]' />,
        },
        {
          name: 'Flutter',
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'Redis', icon: <SiRedis className='w-4 h-4 text-[#C21325]' /> },
        {
          name: 'REST APIs',
    ...
    },
    {
      ...
      skills: [
        ...
        {
          name: 'Cloudflare',
          icon: <FaCloudflare className='w-4 h-4 text-[#F38020]' />,
        },
